...
/// sf::Event::getIf which returns the address of the event struct
/// if it's active or a nullptr otherwise. sf::Event::is is used
/// to check the active event type without actually reading any
/// of the corresponding event data.
///
/// \code
